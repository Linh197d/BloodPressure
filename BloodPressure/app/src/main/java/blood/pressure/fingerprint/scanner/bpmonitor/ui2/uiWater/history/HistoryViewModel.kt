...
import blood.pressure.fingerprint.scanner.bpmonitor.util.utils.dateParser
...
class HistoryViewModel(private val app: Application) : AndroidViewModel(app) {
    ...
    fun dateCollector(): MutableList<String> {
        ...
        if (reversedDrinkData != null) {
            ...
            throw Exception("blood.pressure.fingerprint.scanner.bpmonitor.entities.model.User need to drink first, drink list is null")
        }
