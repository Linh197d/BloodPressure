...
class CustomViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
    ...
    private val drinkNameText = view.findViewById<TextView>(R.id.drinkText)
    private val amountText = view.findViewById<TextView>(R.id.amountText)
    private val drinkImage = view.findViewById<ImageView>(R.id.drinkImage)
...
private fun drinkNameGetter(drink:String, context: Context): String {
    ...
    return when (drink) {
        ...
        else -> "blood.pressure.fingerprint.scanner.bpmonitor.entities.model.Drink"
    }
}
