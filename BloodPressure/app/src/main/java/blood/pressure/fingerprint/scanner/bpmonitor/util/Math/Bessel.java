package blood.pressure.fingerprint.scanner.bpmonitor.util.Math;
...
/**
 * blood.pressure.fingerprint.scanner.bpmonitor.entities.model.User facing class which contains all the methods the user uses to create
