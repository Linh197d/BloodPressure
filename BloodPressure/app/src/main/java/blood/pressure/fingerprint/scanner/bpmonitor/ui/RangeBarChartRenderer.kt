...
import ted.gun0912.rangebarchart.RangeBarDataProvider
...
class RangeBarChartRenderer(
    ...
    private fun drawDataSet(canvas: Canvas, dataSet: RangeBarDataSet) {
...
//            }
            ...
            drawMinMaxValue(canvas, dataSet, entry)
